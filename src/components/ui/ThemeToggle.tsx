...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-line text-ink-dim transition-colors hover:border-accent hover:text-ink"
    >
      {isDark ? (
